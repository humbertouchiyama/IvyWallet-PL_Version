...
class HomeScreenTest: IvyAndroidTest() {
    ...
    fun testSelectingDateRange() = runBlocking<Unit> {
        ...
        val transaction1 = transactionWithTime(Instant.parse("2023-07-21T09:00:00Z")).copy(
            title = "Transaction1"
        )
        val transaction2 = transactionWithTime(Instant.parse("2023-08-10T09:00:00Z")).copy(
            title = "Transaction2"
        )
        val transaction3 = transactionWithTime(Instant.parse("2023-08-30T09:00:00Z")).copy(
            title = "Transaction3"
        )
        ...
        composeRule
            .onNodeWithText("August", substring = true)
            .assertIsDisplayed()
            .performClick()
