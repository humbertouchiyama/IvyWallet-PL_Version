        ...
        writeTransferAct(
            ModifyTransfer.add(
                data = TransferData(
                    ...
                    fee = Value(amount = 10.0, currency = "EUR"),
                    sync = Sync(
        ...
        coVerify {
            writeTrnsBatchAct(
                match {
                    ...
                    from.value == Value(amount = 50.0, currency = "EUR") &&
                            to.value == Value(amount = 60.0, currency = "USD") &&
                            fee.value == Value(amount = 10.0, currency = "EUR") &&
